...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CustOrder>(entity =>
        {
            ...
            entity.HasIndex(e => e.CustId, "IX_Cust_Order_Cust_id");
        ...
        modelBuilder.Entity<CustPhone>(entity =>
        {
            ...
            entity.HasIndex(e => e.CustTempId1, "IX_cust_phone_CustTempId1");
            ...
            entity.HasOne(d => d.CustTempId1Navigation).WithMany(p => p.CustPhones).HasForeignKey(d => d.CustTempId1);
        });
        ...
        modelBuilder.Entity<OrderTransaction>(entity =>
        {
            ...
            entity.HasIndex(e => e.PayId, "IX_Order_Transaction_Pay_id");
        ...
        modelBuilder.Entity<ProdInventory>(entity =>
        {
            ...
            entity.HasIndex(e => e.InventoryId, "IX_Prod_inventory_inventory_id");
        ...
        modelBuilder.Entity<ProdOrder>(entity =>
        {
            ...
            entity.HasIndex(e => e.OId, "IX_Prod_order_O_id");
        ...
        modelBuilder.Entity<SuppCategory>(entity =>
        {
            ...
            entity.HasIndex(e => e.CategoryId, "IX_supp_category_category_id");
